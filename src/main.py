...
if __name__=='__main__':
    ...
    parser.add_argument('-V', default=None,help="Input file, User can enter path of video file or enter cam for webcam.")
    parser.add_argument('-FM', required=True,help="Path to an xml file with a trained model.")
    parser.add_argument('-FLM', required=True,help="Path to an xml file with a trained model.")
    parser.add_argument('-HM', required=True,help="Path to an xml file with a trained model.")
    parser.add_argument('-GM', required=True,help="Path to an xml file with a trained model.")
    parser.add_argument('-D', default='CPU',help="specifying device like CPU,GPU,VPU,FPGA to run inference.")
    parser.add_argument('-FD',default=None,help="Visualizing face detection model output, Enter face_detect .")
    parser.add_argument('-ED',default=None,help="Visualizing left and right eye from facial landmark detection,Enter eye_detect.")
    parser.add_argument('-HD',default=None,help="Visualizing head pose angles from head pose estimation,Enter head_pose.")
    parser.add_argument('-GD',default=None,help="Visualizing gaze vector,Enter gaze_vector.")
